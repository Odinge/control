 ...
 * @LastEditTime: 2019-09-27 15:02:10
 -->
<template>
  <div class="article">
    <Button icon="ios-download-outline" type="primary" style="margin-bottom:20px" v-if="isShow" @click="addQuestion = true">新增问卷</Button>
    ...
    <Page :total="total" show-total show-sizer :current.sync="current" :page-size="pagesize" @on-change="handleCurrent" @on-page-size-change="handlePagesize" />
    <Modal v-model="addQuestion" title="新增问卷" @on-ok="ok" @on-cancel="cancel" :loading="modalLoading">
